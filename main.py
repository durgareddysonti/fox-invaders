...
# Sound
mixer.music.load('251284__djgriffin__135-ravey-game-loop-6.wav.crdownload')
mixer.music.play(-1)
...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state is "ready":
                    bulletSound = mixer.Sound("421184__inspectorj__water-pouring-a.wav.crdownload  ")
                    bulletSound.play()
    ...
    for i in range(num_of_enemies):
        ...
        if collision:
            explosionSound = mixer.Sound("646568__ryanz-official__watersplash.wav.crdownload")
            explosionSound.play()
            bulletY = 480
            bullet_state = "ready"
            score_value += 1
